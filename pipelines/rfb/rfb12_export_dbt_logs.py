...
def backup_logs_to_s3(timestamp_str):
    ...
    html_files = glob.glob(os.path.join(ELEMENTARY_LOGS_DIR, "edr_report_rfb_*.html"))
    if html_files:
        ...
        s3.upload_file(latest_html, "audit", f"elementary/rfb_edr_report_{file_timestamp_str}.html")
